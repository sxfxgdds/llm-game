#!/usr/bin/env python3
"""
Run OS naming game ablation experiments across all OS backends.
...
def main():
    parser = argparse.ArgumentParser(
        description="Run OS naming game ablations across hf / hf_api / groq backends"
    )

    parser.add_argument("--preset", type=str, default=None, help="Preset (hf / hf_api / groq)")
    ...
    parser.add_argument("--outdir", type=str, default="results/os/naming_game_all_os", help="Output directory")
    ...
    logger.info("=" * 60)
    logger.info("OS NAMING GAME (ALL OS BACKENDS)")
    logger.info("=" * 60)
    ...
    logger.info("=" * 60)
    logger.info("OS ALL-BACKEND EXPERIMENT COMPLETE")
    logger.info("=" * 60)
