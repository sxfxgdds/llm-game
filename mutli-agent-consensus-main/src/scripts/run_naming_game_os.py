#!/usr/bin/env python3
"""
Run OS-only naming game ablation experiments.

This runner is specialized for open-source HuggingFace models.
"""
...
def main():
    ...
    parser.add_argument("--preset", type=str, default=None, help="HF preset")
    parser.add_argument("--presets", nargs="+", default=None, help="One or more presets (space or comma separated)")
    parser.add_argument("--model", type=str, default=None, help="HF model id/path")
    parser.add_argument("--models", nargs="+", default=None, help="One or more HF model ids/paths (space or comma separated)")
    ...
    from src.experiments.naming_game_os import NamingGameOSExperiment, NamingGameOSConfig
    ...
    if preset_inputs:
        ...
        for preset in preset_inputs:
            ...
            if backend != "hf":
                parser.error(
                    f"Preset '{preset}' resolves to backend '{backend}', expected 'hf'"
                )
